...
PRODUCT_COMMANDS = (
    ...
    ("vidrensic-repair <artifact> --out <copy> --manifest <report>", "Create verified remux repair copy"),
    ("vidrensic-proxy <artifact> --out <proxy.mp4> --manifest <report>", "Create review transcode proxy"),
    ("vidrensic-review list --case <case>", "List review items"),
    ("vidrensic-review timeline --case <case> --item <id> --out <contract>", "Build review timeline contract"),
    ("vidrensic-review metadata-get --case <case> --item <id> --sha256 <sha>", "Show candidate metadata provenance"),
    ("vidrensic-review deletion-plan --case <case> ...", "Plan safe derived/work cleanup"),
    ("vidrensic-review-ui --case <case>", "Launch local graphical review workstation"),
...
ADVANCED_COMMANDS = (
    ...
    "vidrensic-proxy <artifact> --out <proxy.mp4> --manifest <report> [--json]",
    "vidrensic-review list|set-state|note|bookmark --case <case> ...",
    "vidrensic-review timeline --case <case> --item <id> --timeline-report <report> --out <contract> [--decoder-report <report>]",
    "vidrensic-review metadata-set --case <case> --item <id> --sha256 <sha> --field <field> --value <value> --source-kind <kind> [--source-path <file>] [--source-sha256 <sha>] [--confidence 0..1]",
    "vidrensic-review metadata-get --case <case> --item <id> --sha256 <sha>",
    "vidrensic-review deletion-plan --case <case> --path <derived/work-file>... --reason <text> --out <plan>",
    "vidrensic-review execute-deletion --case <case> --plan <plan> --execute [--tombstones <log>]",
    "vidrensic-review-ui --case <case> [--host 127.0.0.1] [--port 8765] [--open-browser]",
